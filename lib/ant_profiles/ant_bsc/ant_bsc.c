...
LOG_MODULE_REGISTER(ant_bsc, CONFIG_ANT_BSC_LOG_LEVEL);
 ...
 */
static int ant_bsc_init(ant_bsc_profile_t          * p_profile,
                        ant_channel_config_t const * p_channel_config)
{
    ...
    LOG_INF("ANT BSC channel %u init", p_profile->channel_number);
    return ant_channel_init(p_channel_config);
}

int ant_bsc_disp_init(ant_bsc_profile_t           * p_profile,
                      ant_channel_config_t const  * p_channel_config,
...
int ant_bsc_sens_init(ant_bsc_profile_t           * p_profile,
                      ant_channel_config_t const  * p_channel_config,
                      ant_bsc_sens_config_t const * p_sens_config)
{
    ...
    __ASSERT_NO_MSG((p_sens_config->main_page_number == ANT_BSC_PAGE_0)
...
static void sens_message_encode(ant_bsc_profile_t * p_profile, uint8_t * p_message_payload)
{
    ...
    {
        LOG_INF("BSC TX Page: \"Combined Speed & Cadence Page\"");
...
int ant_bsc_disp_open(ant_bsc_profile_t * p_profile)
{
    ...
    LOG_INF("ANT BSC channel %u open", p_profile->channel_number);
...
static void disp_message_decode(ant_bsc_profile_t * p_profile, uint8_t * p_message_payload)
{
    ...
    {
        LOG_INF("BSC RX Page Number: \"Combined Speed & Cadence Page\"");
