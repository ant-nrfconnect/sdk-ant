...
You can then use the ANT+ Display Simulator to test the HRM Transmitter. See the documentation of the ANT+ Simulator tools at https://developer.garmin.com/ant-program/ for information about how to use these tools.
